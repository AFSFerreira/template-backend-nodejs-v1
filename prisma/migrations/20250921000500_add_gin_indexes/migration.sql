...
ALTER TABLE public.blogs
  ADD COLUMN title_unaccent text GENERATED ALWAYS AS (immutable_unaccent(title)) STORED;

ALTER TABLE public.users
  ADD COLUMN full_name_unaccent text GENERATED ALWAYS AS (immutable_unaccent(full_name)) STORED;
