...
import type { IForgotPasswordHtmlTemplate } from '@custom-types/templates/user/forgot-password'
...
export function forgotPasswordHtmlTemplate({
  fullName,
  username,
  token,
  email,
}: IForgotPasswordHtmlTemplate): HtmlTemplateOutput {
					...
					<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
						...
						<tr>
							<td style="padding: 0 40px 40px;">
								<br>
								<h2 style="color: #222; font-size: 24px; margin: 0 0 16px;">Olá, ${toTitleCasePortuguese(fullName)}!</h2>
								...
								<ul style="list-style: none; padding-left: 0; margin: 0 0 24px;">
									<li style="color: #555; font-size: 16px; line-height: 1.6; margin-bottom: 6px;">
										<span style="font-weight: bold; color: #1976d2;">•</span> email: ${email}
									</li>
									<li style="color: #555; font-size: 16px; line-height: 1.6;">
										<span style="font-weight: bold; color: #1976d2;">•</span> username: ${username}
									</li>
								</ul>

								<p style="color: #888; font-size: 14px; line-height: 1.5; margin: 32px 0 16px; border-top: 1px solid #eee;">
									Se você não solicitou a recuperação de senha, por favor, ignore este e-mail. <br>
