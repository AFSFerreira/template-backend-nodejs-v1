        ...
        <tr>
          <td style="padding: 0 40px 40px;">
            ...
            <h2 style="color: #222; font-size: 24px; margin: 0 0 16px;">
              Obrigado, ${toTitleCasePortuguese(fullName)}
            </h2>

            <p style="color: #555; font-size: 16px; line-height: 1.6; margin: 0 0 24px;">
              Confirmamos que a sua conta associada ao e-mail <strong>${email}</strong> foi excluída com sucesso do
              nosso sistema.
            </p>

            <p style="color: #555; font-size: 16px; line-height: 1.6; margin: 0 0 24px;">
              Agradecemos pelo tempo em que esteve conosco. <br>
