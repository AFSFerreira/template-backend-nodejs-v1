...
import { MeetingDefaultPresenter } from '@presenters/variants/meeting/meeting-default.presenter'
import { MeetingDetailedPresenter } from '@presenters/variants/meeting/meeting-detailed.presenter'
