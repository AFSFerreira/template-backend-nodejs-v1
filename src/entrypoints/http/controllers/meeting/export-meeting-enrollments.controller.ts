...
import type { ExportMeetingEnrollmentsUseCase } from '@use-cases/meeting-enrollment/export-meeting-enrollments'
import type { FastifyReply } from 'fastify'
import { injectable } from 'tsyringe'

@injectable()
export class ExportMeetingEnrollmentsController implements IController {
  constructor(private useCase: ExportMeetingEnrollmentsUseCase) {}
