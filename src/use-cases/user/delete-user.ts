...
import { deleteUserHtmlTemplate } from '../../emails/templates/user/delete-user/delete-user-html'
import { deleteUserTextTemplate } from '../../emails/templates/user/delete-user/delete-user-text'
