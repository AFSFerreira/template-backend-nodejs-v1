...
import { deleteUserHtmlTemplate } from '../../templates/emails/user/delete-user/delete-user-html'
import { deleteUserTextTemplate } from '../../templates/emails/user/delete-user/delete-user-text'
