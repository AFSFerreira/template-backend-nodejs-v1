...
import { confirmAccountHtmlTemplate } from '../../emails/templates/user/confirm-account/confirm-account-html'
import { confirmAccountTextTemplate } from '../../emails/templates/user/confirm-account/confirm-account-text'
