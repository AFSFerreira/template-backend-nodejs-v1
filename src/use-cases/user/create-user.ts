...
import { confirmAccountHtmlTemplate } from '../../templates/emails/user/confirm-account/confirm-account-html'
import { confirmAccountTextTemplate } from '../../templates/emails/user/confirm-account/confirm-account-text'
