...
export const HEALTHCHECK_SUCESSFUL = 'A verificação de saúde do servidor foi bem sucedida!'

export const HEALTHCHECK_FAILED = 'A verificação de saúde do servidor falhou!'

export const HEALTHCHECK_ERROR = 'Um erro ocorreu durante a verificação da saúde do servidor'
