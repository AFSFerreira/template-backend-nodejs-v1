...
import type { ISaveFile } from '@custom-types/services/save-file'
...
export async function saveFile({ fileStream, folderPath, originalFilename }: ISaveFile): Promise<FileInfo> {
