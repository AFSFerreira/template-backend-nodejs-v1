...
export async function staticFileRoutes(app: FastifyInstance) {
  const fileRoutes: Array<{ prefix: string; root: string }> = [
    ...
    {
      prefix: STATIC_MEETING_AGENDAS_ROUTE,
      root: MEETING_AGENDAS_PATH,
    },
    {
    ...
    {
      prefix: STATIC_INSTITUTIONAL_INFO_DOCUMENTS_ROUTE,
      root: INSTITUTIONAL_INFO_PUBLIC_DOCUMENTS_PATH,
    },
    {
