import { COMPLETION_DATE_BEFORE_START_DATE, SCHOLARSHIP_HOLDER_AND_SPONSORING_ORGANIZATION } from "@messages/validations"
import z from "zod"
import { monthYearSchema } from "./month-year-schema"
