...
export interface AreaOfActivityRepository {
  ...
  findByMainAreaActivity: (mainAreaActivity: string) => Promise<AreaOfActivity | null>
  delete: (id: string) => Promise<void>
  update: (id: string, data: Prisma.AreaOfActivityUpdateInput) => Promise<AreaOfActivity>
}
