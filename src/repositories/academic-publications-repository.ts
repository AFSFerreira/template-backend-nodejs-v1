...
export interface AcademicPublicationsRepository {
  create: (data: Prisma.AcademicPublicationsUncheckedCreateInput) => Promise<AcademicPublications>
  ...
  update: (id: number, data: Prisma.AcademicPublicationsUpdateInput) => Promise<AcademicPublications>
}
