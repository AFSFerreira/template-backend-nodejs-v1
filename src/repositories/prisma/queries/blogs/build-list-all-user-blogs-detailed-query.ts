import type { IBuildGetAllUserBlogsDetailedQuerySchemaType } from '@custom-types/query/blogs/user-blog-detailed'
...
export function buildListAllUserBlogsDetailedQuery(query: IBuildGetAllUserBlogsDetailedQuerySchemaType) {
  const conditions: Prisma.Sql[] = [Prisma.sql`b.user_id = ${query.userId}`]
