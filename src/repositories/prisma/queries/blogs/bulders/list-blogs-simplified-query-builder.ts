...
export class ListBlogsSimplifiedQueryBuilder {
  private conditions: Prisma.Sql[] = [
    Prisma.sql`b.editorial_status = ${EditorialStatusType.PUBLISHED}::"EditorialStatusType"`,
  ]
  ...
  public withSorting(orderBy?: IBuildListAllUserBlogsDetailedQuery['orderBy']): this {
