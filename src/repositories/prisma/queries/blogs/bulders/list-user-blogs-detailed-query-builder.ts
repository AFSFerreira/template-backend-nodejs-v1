...
export class ListUserBlogsDetailedQueryBuilder {
  ...
  public withUserId(userId: number): this {
    this.conditions.push(Prisma.sql`b.user_id = ${userId}`)
  ...
  public withSorting(orderBy?: IBuildGetAllUserBlogsDetailedQuerySchemaType['orderBy']): this {
