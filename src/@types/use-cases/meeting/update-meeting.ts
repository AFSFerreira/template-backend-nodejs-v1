import type { UpdateMeetingBodySchemaType } from '@custom-types/schemas/meeting/update-meeting-body-schema'
import type { UpdateMeetingParamsSchemaType } from '@custom-types/schemas/meeting/update-meeting-params-schema'
